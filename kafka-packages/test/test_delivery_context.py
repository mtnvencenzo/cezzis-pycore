...
class TestDeliveryContext:
    ...
    def test_init_with_required_parameters(self):
        ...
        context = DeliveryContext(message_id="test-msg-123", topic="test-topic")
    ...
    def test_default_attempt_count(self):
        ...
        context = DeliveryContext(message_id="test-msg", topic="test-topic")
    ...
    def test_metadata_independence(self):
        ...
        context1 = DeliveryContext(message_id="msg-1", topic="topic-1")
        context2 = DeliveryContext(message_id="msg-2", topic="topic-2")
    ...
    def test_string_representation(self):
        ...
        context = DeliveryContext(
            message_id="test-msg-789", topic="log-events", attempt_count=2, metadata={"key": "value"}
        )
    ...
    def test_equality(self):
        ...
        context1 = DeliveryContext(
            message_id="same-msg", topic="same-topic", attempt_count=1, original_timestamp=timestamp, metadata=metadata
        )
    ...
    def test_metadata_types(self):
        ...
        context = DeliveryContext(message_id="test-msg", topic="test-topic", metadata=metadata)
    ...
    def test_various_id_topic_combinations(self, message_id, topic):
        ...
        context = DeliveryContext(message_id=message_id, topic=topic)
    ...
    def test_custom_timestamp(self):
        ...
        context = DeliveryContext(message_id="test-msg", topic="test-topic", original_timestamp=custom_timestamp)
    ...
    def test_attempt_count_edge_cases(self):
        ...
        # Zero attempts
        context1 = DeliveryContext(message_id="test-msg", topic="test-topic", attempt_count=0)
        assert context1.attempt_count == 0

        # Large number of attempts
        context2 = DeliveryContext(message_id="test-msg", topic="test-topic", attempt_count=1000)
        assert context2.attempt_count == 1000

        # Negative attempts (unusual but allowed by dataclass)
        context3 = DeliveryContext(message_id="test-msg", topic="test-topic", attempt_count=-1)
